...
# Special sign .dot to compute inner products of vectors, to multiply a vector by a matrix, and to multiply matrices
x = np.array([[1,2],[3,4]])
y = np.array([[5,6],[7,8]])
...
# We are allowed to compute without additional copies of V
